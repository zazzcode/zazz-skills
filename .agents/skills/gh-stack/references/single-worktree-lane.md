...
git worktree add ../mw-next-report-lane -b mw-next-report-svc-1 <integration-branch>

cd ../mw-next-report-lane
# currently on mw-next-report-svc-1

gh stack init --base <integration-branch> --adopt mw-next-report-svc-1
...
```bash
cd <container-root>/<integration-worktree>
git worktree add ../mw-<report-slug>-lane -b mw-<report-slug>-svc-1 <integration-branch>
...
```bash
gh stack init --base <integration-branch> --adopt mw-<report-slug>-svc-1
...
```bash
cd <container-root>/mw-next-report-lane
